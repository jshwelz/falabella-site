...
.directive('uibAccordionGroup', function() {
  return {
    ...
    scope: {
      ...
      sucursal: '@',               // Interpolate the heading attribute onto this scope
    ...
    controller: function() {
      ...
      this.setsucursal = function(element) {
    ...
    scope.Filter = function(value) {
         //alert(scope.$parent.prueba);
         //alert(value);
         //scope.$parent.filterId = value;
         scope.$parent.filterZona(value);
      };
...
angular.module("uib/template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/accordion/accordion-group.html",
    ...
    "      <a role=\"button\" data-toggle=\"collapse\" href aria-expanded=\"{{isOpen}}\" aria-controls=\"{{::panelId}}\" tabindex=\"0\" class=\"accordion-toggle\" ng-click=\"FilterZona(heading);Filter(sucursal);toggleOpen()\" uib-accordion-transclude=\"heading\"><span uib-accordion-header ng-class=\"{'text-muted': isDisabled}\">{{heading}}</span></a>\n" +
    "    </h4>\n" +
    "  </div>\n" +
